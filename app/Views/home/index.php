<!-- ===== HERO ===== -->
<section class="relative bg-noir text-blanc bg-cover bg-center"
    style="background-image: url('<?= url('assets/images/bg-hero.png') ?>');">
    <!-- Voile sombre pour la lisibilité du texte -->
    <div class="absolute inset-0 bg-noir/50"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-6 py-28 md:py-36">
        <div class="max-w-xl">
            ...
            <p class="text-sm text-blanc/70 leading-relaxed mb-8">
                Une sélection curatée de fragrances de niche, conçues par des maîtres parfumeurs indépendants. Des
                matières rares, un savoir-faire d'exception.
            </p>
            <div class="flex flex-wrap gap-3">
                <a href="<?= url('parfums') ?>"
                    class="inline-block px-8 py-3 bg-blanc text-noir text-xs tracking-[0.25em] uppercase hover:bg-bordeaux hover:text-blanc transition-colors">
                    Découvrir la collection
                </a>
                <a href="<?= url('maison') ?>"
                    class="inline-block px-8 py-3 border border-blanc/40 text-blanc text-xs tracking-[0.25em] uppercase hover:bg-blanc hover:text-noir transition-colors">
                    Notre histoire
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <?php foreach ($produitsVedette as $produit): ?>
                <a href="<?= url('parfums/' . e($produit['slug'])) ?>" class="group block">
                    ...
                    <h3 class="font-serif text-lg mb-1 group-hover:text-bordeaux transition-colors"><?= e($produit['nom']) ?>
                    </h3>
...
<section class="bg-noir text-blanc">
    <div class="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        <img src="<?= url('assets/images/maison.png') ?>" alt="Alur Paris" lass="aspect-[4/5] bg-bordeaux/30">
        ...
        <div>
            ...
            <p class="text-sm text-blanc/70 leading-relaxed mb-8">
                Depuis notre atelier parisien, nous travaillons les matières premières les plus rares avec le respect dû
                à un art ancestral. Chaque fragrance est le fruit d'une recherche minutieuse, d'une obsession du détail.
            </p>
            <a href="<?= url('maison') ?>"
                class="inline-block px-8 py-3 border border-blanc text-blanc text-xs tracking-[0.25em] uppercase hover:bg-blanc hover:text-noir transition-colors">
                En savoir plus
            </a>
        </div>
    </div>
